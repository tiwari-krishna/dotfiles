...
label = %{F#e69}  %mb_used%/%gb_total%%{F-}
...
format-connected = %{F#eae}   <label-connected> %{F-}
...
format-charging = %{F#690} <label-charging>%{F-}
format-charging-underline = #ffb52a

format-discharging = %{F#690} <label-discharging>%{F-}
